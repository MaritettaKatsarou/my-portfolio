      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        <div className="lg:col-span-7">
          ...
          <div className="space-y-6">
            <h2 className="font-bold text-sm uppercase tracking-widest border-b border-slate-100 pb-2">The Challenge</h2>
        ...
        <div className="lg:col-span-5">
          <div className="lg:sticky lg:top-32 ml-0 lg:ml-8 pl-0 lg:pl-6 py-12 lg:py-2 border-t lg:border-t-0 lg:border-l-2 border-slate-100 mt-12 lg:mt-0">
            <h2 className="font-mono font-semibold text-[12px] uppercase tracking-[0.20em] text-slate-400 mb-8">Project Statistics</h2>

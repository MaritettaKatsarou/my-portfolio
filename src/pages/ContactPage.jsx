...
const actionClassName = 'min-h-11 inline-flex items-center gap-3 rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700 transition-all hover:border-blue-100 hover:text-blue-600'

export default function ContactPage() {
  return (
    <section className="max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      <p className="mb-3 font-mono text-xs uppercase tracking-widest text-blue-600">Contact</p>
